...
export const projects: Project[] = [
  ...
  },
  {
    ...
    vodEmbedUrls: [],
    videoItems: [
      { url: 'https://1417160487.vod-qcloud.com/01f64ba9vodcq1417160487/e78e47855145403720508567855/gWJpKjG1YnoA.mp4', title: '屏幕替换', caption: '将原始屏幕内容替换为目标画面。' },
      { url: 'https://1417160487.vod-qcloud.com/01f64ba9vodcq1417160487/8d38530e5145403719699195434/PTiQenCa9DsA.mp4', title: '相机跟踪', caption: '完成实拍镜头的三维相机解算。' },
      { url: 'https://1417160487.vod-qcloud.com/01f64ba9vodcq1417160487/ac6670ae5145403719774313889/tR7GunYQJE0A.mp4', title: '文字替换', caption: '替换画面中的原有文字信息。' },
      { url: 'https://1417160487.vod-qcloud.com/01f64ba9vodcq1417160487/8cc5788c5145403721222017720/Vw4rpB7oaEkA.mp4', title: '绿幕背景替换', caption: '完成抠像并重建新的背景环境。' },
    ],
  },
  {
    slug: 'taison',
